...
file = open("day-11/inputs/part_2.txt")
...
for g1, g2 in combinations(galaxies, r=2):
    ...
    dx = sum(999_999 if min_x < row <= max_x else 0 for row in empty_rows)
    dy = sum(999_999 if min_y < col <= max_y else 0 for col in empty_cols)
